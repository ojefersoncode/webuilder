  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-b from-background to-muted">
        <h1 className="text-5xl font-bold tracking-tight mb-6">Build beautiful websites<br />without code</h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">Simply drag components onto your page and arrange them exactly how you want.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="bg-primary/10 p-4 rounded-full mb-6">
              ...
              <p className="text-muted-foreground">Easily customize colors, fonts, and content to match your brand and vision.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="bg-primary/10 p-4 rounded-full mb-6">
              ...
              <p className="text-muted-foreground">Publish your site with one click and share it with the world.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 text-center md:text-left text-sm text-muted-foreground">
            © {new Date().getFullYear()} DragDrop. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
